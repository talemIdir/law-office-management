...
2. **Create Toast Wrapper** (`src/utils/toast.js`):
   ...
   export const showSuccess = (message) => toast.success(message, { position: 'top-left' });
   export const showError = (message) => toast.error(message, { position: 'top-left' });
   export const showWarning = (message) => toast.warning(message, { position: 'top-left' });
...
export const WILAYAS = [
  'أدرار', 'الشلف', 'الأغواط', /* ... all 58 wilayas */
];
