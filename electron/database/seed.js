  ...
  try {
    ...
    const clients = await Client.bulkCreate([
      // Individual clients
      {
        ...
        address: "حي النصر، عمارة رقم 12",
        city: "Alger Centre",
        wilaya: "Alger",
        notes: "عميل مهم، يفضل التواصل صباحاً",
        status: "active",
      },
      {
        type: "individual",
      ...
      // Company clients
      {
        ...
        address: "المنطقة الصناعية، الطريق الوطني رقم 1",
        city: "Alger",
        wilaya: "Alger",
        notes: "شركة تجارية كبرى",
        status: "active",
      },
      {
        type: "company",
        companyName: "مؤسسة النجاح للبناء",
        nationalId: "8765432109876",
        taxId: "087654321098765",
        phone: "0666888999",
        email: "info@ennajah.dz",
        address: "حي الصناعي، عمارة رقم 15",
        city: "Oran",
        wilaya: "Oran",
        status: "active",
      },
      ...
      },
      {
        ...
        address: "شارع ديدوش مراد، رقم 89",
        city: "Béjaïa",
        wilaya: "Béjaïa",
        status: "active",
      },
    ...
    const cases = await Case.bulkCreate([
      {
        ...
        description: "نزاع حول عقد توريد بضائع بين شركتين",
        caseType: "commercial",
        ...
        amount: 850000.0,
        notes: "القضية في مرحلة متقدمة، الجلسة القادمة حاسمة",
      ...
      },
      {
        caseNumber: "2024/002",
        title: "قضية طلاق",
        description: "طلاق بالتراضي مع تسوية حضانة الأطفال",
        caseType: "family",
        ...
        notes: "الطرفان متفاهمان، يتبقى تسوية النفقة",
      ...
      },
      {
        ...
        description: "احتيال في صفقة عقارية",
        caseType: "criminal",
        ...
        endDate: pastDate(30),
        amount: 5000000.0,
        notes: "تم الاستئناف ضد الحكم الابتدائي",
      ...
      },
      {
        ...
        endDate: pastDate(20),
        amount: 150000.0,
        notes: "تم كسب القضية والحصول على التعويض الكامل",
    ...
    const invoices = await Invoice.bulkCreate([
      {
        ...
        description: "أتعاب قضية نزاع تجاري - مرحلة أولى",
        amount: 200000.0,
        taxAmount: 38000.0,
        totalAmount: 238000.0,
        paidAmount: 238000.0,
        status: "paid",
      ...
      },
      {
        ...
        description: "أتعاب قضية حادث مرور",
        amount: 100000.0,
        taxAmount: 19000.0,
      ...
      },
      {
        ...
        invoiceDate: pastDate(40),
        dueDate: pastDate(10),
        description: "أتعاب قضية نزاع عمالي - مرحلة أولى",
        amount: 180000.0,
        taxAmount: 34200.0,
        totalAmount: 214200.0,
        paidAmount: 0,
        status: "overdue",
        notes: "متأخر عن الدفع - يجب المتابعة",
        clientId: clients[3].id,
        caseId: cases[3].id,
      },
      {
        invoiceNumber: "INV-2024-005",
        invoiceDate: pastDate(5),
        dueDate: futureDate(25),
        description: "استشارة قانونية - حصة واحدة",
        amount: 50000.0,
        taxAmount: 9500.0,
        totalAmount: 59500.0,
        paidAmount: 0,
        status: "draft",
        notes: "مسودة - لم يتم إرسالها بعد",
        clientId: clients[0].id,
      },
      {
        invoiceNumber: "INV-2024-006",
        invoiceDate: pastDate(50),
        dueDate: pastDate(20),
        description: "أتعاب قضية ميراث - المرحلة الأولى",
        amount: 250000.0,
        taxAmount: 47500.0,
        totalAmount: 297500.0,
        paidAmount: 297500.0,
        status: "paid",
        clientId: clients[4].id,
        caseId: cases[4].id,
      },
      {
        ...
        description: "أتعاب قضية نزاع عقاري",
        amount: 300000.0,
        taxAmount: 57000.0,
        totalAmount: 357000.0,
        paidAmount: 150000.0,
        status: "partially_paid",
        notes: "دفعة أولى - المتبقي 207000 دج",
        clientId: clients[6].id,
        caseId: cases[6].id,
      },
    ]);
